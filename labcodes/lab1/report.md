...
>参考并理解了lab1_result中的代码，部分简单而繁杂的题目直接引用了lab1_result中的答案。
...
[练习1.2] 一个被系统认为是符合规范的硬盘主引导扇区的特征使什么?

答:磁盘主引导扇区只有512字节。且第510个字节为0x55，第511个（倒数第一个）字节为0xAA。
